...
async function selectChapter(chapterId: number, wholeChapter = false) {
  ...
  const list = await api.fetchQuestions(chapterId, { includeChildren: wholeChapter })
...
async function submitAnswer() {
  ...
  questions.value = await api.fetchQuestions(selectedChapterId.value, { includeChildren: includeChildren.value })
}
